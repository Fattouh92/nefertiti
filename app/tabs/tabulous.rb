Tabulous.setup do
  ...
  tabs do
    ...
    boats_tab do
      text          { 'Boats' }
      link_path     { boats_path }
      visible_when  { true }
      enabled_when  { true }
      active_when   { in_action('any').of_controller('boats') }
    end
    ...
    cv_tab do
      ...
      visible_when  { true }
      enabled_when  { true }
      active_when   { in_action('any').of_controller('cv') }
    end

    career_tab do
      text          { 'Career' }
      link_path     { career_path }
      visible_when  { true }
      enabled_when  { true }
      active_when   { in_action('any').of_controller('career') }
    end

    contact_tab do
      text          { 'Contact us' }
      link_path     { contact_path }
      visible_when  { true }
      enabled_when  { true }
      active_when   { in_action('any').of_controller('contact') }
    end
